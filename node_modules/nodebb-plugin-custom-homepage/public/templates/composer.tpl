  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      	...
      	<div class="container-fluid">
		    ...
		    <div class="form-group">
				...
				<div class="tags-container">
					<textarea type="text" class="reagents form-control" placeholder="Describe purpose of protocol" tabindex="4" rows="2"/>
				</div>
	      	</div>
	      	<div class="form-group">
      ...
      <div class="modal-footer">
		...
		<button class="btn btn-primary" data-action="post" tabindex="10"><i class="fa fa-check"></i> [[topic:composer.submit]]</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
