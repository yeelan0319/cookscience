...
(function(search) {
	...
	search.categorySummary = function(params, callback){
		var results = params.results;
		results.resultsInCategoryCount = _.chain(results.posts)
			.countBy(function(post){ return post.category.name;})
			.map(function(count, categoryName){ 
				var category = _.findWhere(results.categories, {name: categoryName});
				return {
					cid: category.cid,
			...
			.value();
		results.search_query_escaped = escape(results.search_query);
