		...
		results.results.resultsInCategoryCount = _.chain(results.results.posts)
			.map(function(post){
				...
				if(typeof post.content !== "string"){
					var purpose = 'Purpose: ' + post.content.purpose + '<br>';
					var reagents = 'Reagents: ' + post.content.reagents + '<br>';
					var procedure = 'Procedure: ' + post.content.procedure + '<br>';
					var result = 'Expected Result: ' + post.content.result + '<br>';
					var reference = 'Reference: ' + post.content.reference;
					post.content = purpose + reagents + procedure + result + reference;
				}
				return post;
			})
